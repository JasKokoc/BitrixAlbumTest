...
<div class="bx-authform">
    ...
    <form id="js-main-auth-form" name="<?= $arResult['FORM_ID']; ?>" method="post" target="_top"
          action="<?= POST_FORM_ACTION_URI; ?>">


        <div class="form-floating">
            <input type="email" class="form-control" name="<?= $arResult['FIELDS']['login']; ?>" maxlength="255"
        ...
        <div class="form-floating">
            ...
            <input type="password" class="form-control" name="<?= $arResult['FIELDS']['password']; ?>" maxlength="255"
        ...
        if ($arResult['CAPTCHA_CODE']): ?>
            ...
            <div class="bx-authform-formgroup-container dbg_captha">
                ...
                <div class="bx-captcha"><img src="/bitrix/tools/captcha.php?captcha_sid=<?= \htmlspecialcharsbx(
                ...
                <div class="checkbox">
                    <label class="bx-filter-param-label">
                        <input type="checkbox" id="USER_REMEMBER" name="<?= $arResult['FIELDS']['remember']; ?>"
                               value="Y"/>
                        <span class="bx-filter-param-text"><?= Loc::getMessage(
                                'MAIN_AUTH_FORM_FIELD_REMEMBER'
                            ); ?></span>
                    </label>
                </div>
            </div>
        ...
        <div class="bx-authform-formgroup-container">
            <input type="submit" class="w-100 btn btn-lg btn-primary" name="<?= $arResult['FIELDS']['action']; ?>"
